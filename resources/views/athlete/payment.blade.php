...
<head>
    ...
    <title>Informasi Pembayaran - D'AMERTA SWIM</title>
            ...
            <div class="max-w-xl mx-auto space-y-6">
                    ...
                    <div class="p-6 md:p-8 space-y-6">
                        ...
                        <div class="border-b border-gray-100 pb-4">
                            ...
                            <div class="flex items-center justify-between bg-gray-50 p-3 rounded-xl border border-gray-200">
                                <span id="rekeningNum" class="text-xl md:text-2xl font-mono font-bold text-indigo-600 tracking-wider">
                                    5745815461
                                </span>
                ...
                <div class="bg-indigo-50 border border-indigo-100 rounded-2xl p-4 text-xs text-indigo-900 flex items-start gap-3">
                    ...
                    <p class="leading-relaxed">
                        Silakan lakukan pembayaran iuran bulanan ke rekening di atas. Setelah melakukan transfer, simpan bukti pembayaran dan konfirmasi ke nomor whatsapp admin.
                    </p>
                </div>
            </div>
